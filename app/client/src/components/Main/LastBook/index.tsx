...
const LastBook: FC<LastBookProps> = ({ lastBook, lastBookText }) => {
    return (
        <div className="border-nightbg border-2 h-1/3 xl:m-5 2xl:m-10 2xl:mt-5 rounded-3xl flex items-center">
            <div className="2xl:mr-8 xl:mr-0 flex flex-col h-full w-5/6 2xl:gap-5 xl:gap-1 p-5 justify-between">
                <div className="h-full flex flex-col gap-1 text-center">
                    ...
                    <div className="flex gap-2 justify-center oveflow-hidden">
                        <h1 className="2xl:text-4xl xl:text-2xl text-blue-gray-400 font-bold text-center line-clamp-1">
                    ...
                    <h2 className="max-h-full 2xl:text-[44px] xl:text-[28px] text-gray-500 text-justify overflow-hidden 2xl:line-clamp-3 xl:line-clamp-2">
                        {lastBookText}
                    </h2>
                    {/* </div> */}
                </div>
                <div className="flex w-full items-center">
                    <h3 className="2xl:text-2xl xl:text-md font-semibold text-white/80">
