...
type AuthProps = {
    isPassword: boolean
    setPassword: (data: boolean) => void
}

const Auth = ({ isPassword, setPassword }: AuthProps): ReactElement => {
    return (
        <>
            <div className="flex justify-center items-center w-100v h-100v bg-gray-100">
                <div className="w-3/5 m-9 flex items-center rounded-3xl h-80v bg-white shadow-lg shadow-slate-500 overflow-hidden 2xl:bg-login xl:bg-login md:bg-login-mobile sm:bg-login-mobile bg-cover opacity-80">
                    <div className=" w-full grid 2xl:grid-cols-2 xl:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 justify-end">
                        <div className="2xl:p-24 xl:p-12 grid grid-rows-3 items-center">
                            ...
                            <h1 className="2xl:text-6xl xl:text-4xl md:text-2xl sm:text-xl font-bold flex">
                                Create new account
                            </h1>
                            <h2 className="2xl:text-4xl xl:text-2xl md:text-xl sm:text-lg text-blue-gray-300">
                                Already a Member?{' '}
                            ...
                            <div className="flex gap-3 justify-between h-12 items-center my-3">
                                <div className="w-3/5">
                                    <Input
                                        size={'lg'}
                                        color="blue"
                            ...
                            <div className="flex my-3 justify-end">
                                <Button
                                    className="rounded-3xl w-3/7 h-12 capitalize text-md"
                                    variant="filled"
                                >
                                    Create account
                                </Button>
                    ...
                    {/* <div className="min-h-full h-overflow w-full flex bg-login bg-cover" /> */}
                </div>
            </div>
        </>
    )
